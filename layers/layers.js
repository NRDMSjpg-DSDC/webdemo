...
var format_Rural_SC_4 = new ol.format.GeoJSON();
var features_Rural_SC_4 = format_Rural_SC_4.readFeatures(json_Rural_SC_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7755'});
var jsonSource_Rural_SC_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rural_SC_4.addFeatures(features_Rural_SC_4);
cluster_Rural_SC_4 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_Rural_SC_4
});
var lyr_Rural_SC_4 = new ol.layer.Vector({
                declutter: false,
                source:cluster_Rural_SC_4, 
                style: style_Rural_SC_4,
                popuplayertitle: 'Rural_SC',
                interactive: true,
                title: 'Rural_SC'
            });
var format_Rural_other_than_sc_5 = new ol.format.GeoJSON();
var features_Rural_other_than_sc_5 = format_Rural_other_than_sc_5.readFeatures(json_Rural_other_than_sc_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7755'});
var jsonSource_Rural_other_than_sc_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rural_other_than_sc_5.addFeatures(features_Rural_other_than_sc_5);
cluster_Rural_other_than_sc_5 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_Rural_other_than_sc_5
});
var lyr_Rural_other_than_sc_5 = new ol.layer.Vector({
                declutter: false,
                source:cluster_Rural_other_than_sc_5, 
                style: style_Rural_other_than_sc_5,
                popuplayertitle: 'Rural_other_than_sc',
                interactive: true,
                title: 'Rural_other_than_sc'
            });
...
lyr_WorldImagery_0.setVisible(false);lyr_OpenStreetMap_1.setVisible(true);lyr_WB_Block_Boundary_2.setVisible(true);lyr_WB_District_Boundary_3.setVisible(true);lyr_Rural_SC_4.setVisible(true);lyr_Rural_other_than_sc_5.setVisible(true);lyr_Urban_6.setVisible(true);
var layersList = [lyr_WorldImagery_0,lyr_OpenStreetMap_1,lyr_WB_Block_Boundary_2,lyr_WB_District_Boundary_3,lyr_Rural_SC_4,lyr_Rural_other_than_sc_5,lyr_Urban_6];
...
lyr_Rural_SC_4.set('fieldAliases', {'Facility_N': 'Facility_N', 'NIN_2_HFI': 'NIN_2_HFI', 'State': 'State', 'District': 'District', 'Taluka': 'Taluka', 'Block': 'Block', 'Facility_T': 'Facility_T', 'Latitude': 'Latitude', 'longitude': 'longitude', 'Region_Ind': 'Region_Ind', 'Operationa': 'Operationa', 'Ownership': 'Ownership', });
lyr_Rural_other_than_sc_5.set('fieldAliases', {'Sl_No_': 'Sl_No_', 'District_N': 'District_N', 'Health_Fac': 'Health_Fac', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Category': 'Category', });
...
lyr_Rural_SC_4.set('fieldImages', {'Facility_N': 'TextEdit', 'NIN_2_HFI': 'TextEdit', 'State': 'TextEdit', 'District': 'TextEdit', 'Taluka': 'TextEdit', 'Block': 'TextEdit', 'Facility_T': 'TextEdit', 'Latitude': 'TextEdit', 'longitude': 'TextEdit', 'Region_Ind': 'TextEdit', 'Operationa': 'TextEdit', 'Ownership': 'TextEdit', });
lyr_Rural_other_than_sc_5.set('fieldImages', {'Sl_No_': 'TextEdit', 'District_N': 'TextEdit', 'Health_Fac': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Category': 'TextEdit', });
...
lyr_Rural_SC_4.set('fieldLabels', {'Facility_N': 'no label', 'NIN_2_HFI': 'no label', 'State': 'no label', 'District': 'no label', 'Taluka': 'no label', 'Block': 'no label', 'Facility_T': 'no label', 'Latitude': 'no label', 'longitude': 'no label', 'Region_Ind': 'no label', 'Operationa': 'no label', 'Ownership': 'no label', });
lyr_Rural_other_than_sc_5.set('fieldLabels', {'Sl_No_': 'no label', 'District_N': 'no label', 'Health_Fac': 'no label', 'Latitude': 'no label', 'Longitude': 'no label', 'Category': 'no label', });
lyr_Urban_6.set('fieldLabels', {'SL_No': 'no label', 'District_n': 'no label', 'ULB_Name': 'no label', 'Facility_N': 'no label', 'NIN_ID': 'no label', 'Latitude': 'no label', 'longitude': 'no label', 'Type_of_Bu': 'no label', 'Functional': 'no label', 'Remarks': 'no label', 'Facility_T': 'no label', });
