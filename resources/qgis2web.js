...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:7755',
            //extent: [4583762.691646, 3758894.191833, 4965186.170774, 4372358.527626],
            units: 'm'
        })
    })
});
...
map.getView().fit([4583762.691646, 3758894.191833, 4965186.170774, 4372358.527626], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">SSDC/DSDC WEBGIS DEMO</h2>';
        return titleElement;
    })(),
